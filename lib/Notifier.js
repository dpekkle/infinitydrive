...
var Notifier = (function() {
    ...
    var config = { /* How long the notification stays visible */
        ...
        box_styles: {
            ...
            opacity: 0.8,
            color: "#fff",
            font: "normal 13px 'sans-serif', 'Lucida Grande', Verdana, Arial, Helvetica, sans-serif",
            borderRadius: "3px",
    ...
    return {
        notify: function(message, title, image, fade) {

            var notification = document.createElement('div');
			notification.id = title + "note";
